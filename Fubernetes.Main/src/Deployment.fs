...
module Deployment =
    ...
    type SimpleEnv = { Name: string; Value: string }
    ...
    type VolumeFromPVC = { Name: string; ClaimName: string }
...
//         | Some arguments ->
//             arguments
//             |> Configuration.reduceIfNotEmpty (fun (acc: string) (el: string) -> $"\"{acc}\", \"{el}\"")
//             |> function
//                 | value -> $"args: [ {value} ]"
//         | None -> ""
...
//             |> Configuration.reduceIfNotEmpty (+)
//         | None -> ""
...
//     let templatePath = Configuration.getTemplatesDirPath "/deployment/Pod.template"
...
//     |> this.addVolumes
//     |> Configuration.replaceTabsWithSpaces
//     |> Configuration.removeEmptyLines
